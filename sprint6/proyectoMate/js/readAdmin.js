leerDatos = () => {
  var ruta = "http://localhost:8080/servicioProyecto/readAdmin.php";
  fetch(ruta)
...
eliminarAdministrador = (codigo) => {
  var ruta = "http://localhost:8080/servicioProyecto/deleteAdmin.php";
...
$("#btnActualizar").click(() => {
  ...
  var ruta = "http://localhost:8080/servicioProyecto/updateAdmin.php";
