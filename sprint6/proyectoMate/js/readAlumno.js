leerDatos = () => {
  var ruta = "http://localhost:8080/servicioProyecto/readAlumno.php";
  fetch(ruta)
...
eliminarAlumno = (codigo) => {
  var ruta = "http://localhost:8080/servicioProyecto/deleteAlumno.php";
...
$("#btnActualizar").click(() => {
  ...
  var ruta = "http://localhost:8080/servicioProyecto/updateAlumno.php";
...
$("#btnRegistrar").click(() => {
  ...
  var ruta = "http://localhost:8080/servicioProyecto/insertAlumno.php";
