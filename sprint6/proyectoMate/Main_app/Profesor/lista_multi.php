...
<body>
    ...
    <div class="titulo">
        <h2>Puntaje de alumnos (Juego Multiplicación)</h2>
    </div>    
...
<div class="modal fade" id="modal-promedio_total" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Promedio de puntos del Juego de Multiplicación</h5>
        <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"> -->
          <!-- <span aria-hidden="true">&times;</span> -->
        </button>
      </div>
    ...
    <script src="./../../js/lista_multi.js"></script>
