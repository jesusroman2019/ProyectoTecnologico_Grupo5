...
<body>
      ...
      <div class="nav">
        ...
        <nav>
          <ul>
            ...
            <li><a href="multi.php">Multiplicación</a></li>
  ...
  <div class="wrapper">
      <div class="equation">        
        ...
        <div id="buttons">
          <button id="btnStart">Empieza</button>
          <button id="btnPause">Pausa</button>
          <button id="btnReStart">Limpia</button>
        </div>

          <!-- <ul id="buttons">
            <li><button id="btnStart">Empieza</button></li>
            <li><button id="btnPause">Pausa</button></li>
            <li><button id="btnReStart">Limpia</button></li>
          </ul> -->
